...
package VER="v1":
    ...
    cd {{justfile_directory()}} && zip -r -FS dist/GruvboxDarkThemeFirefoxPluskMiku-{{VER}}.zip * --exclude '*.git*' --exclude '*.mp4' --exclude '*~' --exclude 'dist' --exclude 'justfile' --exclude 'prev.png'
